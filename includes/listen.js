...
(async function () {
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body == `${prefix}request`) {
        ...
        return api.sendMessage(`✔ APNAR 𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐀𝐃𝐌𝐈𝐍 er kache pathano HoLo ♥️\n\n « ❰͟͞❰͟͞⸙͟͞𝐂͟͞𝐇͟͞𝐀͟͞𝐍͟͞𝐃͟͞⸙͟͟͞͞❱͟͞❱ »`, event.threadID);
      }
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`⚠️ আপনার গ্রুপের বা ইনবক্স এর এপ্রভাল নাই NAZRUL এর জিলাপি  bot ব্যাবহার করতে হলে! আপনার আগে পারমিশন লাগবে। পারমিশন নিতে NAZRUL ব০০স কে ইনবক্স করুন অথবা 💫/request💫 কমান্ড টা ব্যাবহার করেন ধন্যবাদ🥀🥀।\n\n${prefix}request\n\n✅🥀💯\n\n𝐎𝐰𝐧𝐞𝐫 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤\nhttps://www.facebook.com/profile.php?id=100074577351053\n\n« ❰͟͞❰͟͞⸙͟͞𝐂͟͞𝐇͟͞𝐀͟͞𝐍͟͞𝐃͟͞⸙͟͟͞͞❱͟͞❱ »`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
