...
const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! EVERYONE , THIS BOT WAS MADE BY NAZRUL ISLAM! CONTACT HER ON FACEBOOK: https://www.facebook.com/profile.php?id=100074577351053  .. CONTACT ON YOUTUBE: ");
    res.end();
});
